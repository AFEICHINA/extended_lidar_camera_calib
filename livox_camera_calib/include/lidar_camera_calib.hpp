...
public:
  ...
  Calibration(const std::string &camera_file, const std::string &calib_file,
              const std::string &bag_path, const std::string &pcd_path);
  void loadImgAndPointcloud(const std::string bag_path,
                            pcl::PointCloud<pcl::PointXYZI>::Ptr &origin_cloud,
                            cv::Mat &rgb_img);
  void loadImgAndPointcloudFromPCD(const std::string bag_path, const std::string pcd_path,
                            pcl::PointCloud<pcl::PointXYZI>::Ptr &origin_cloud,
                            cv::Mat &rgb_img);
...
Calibration::Calibration(const std::string &camera_file,
  ...
  loadImgAndPointcloudFromPCD(bag_path, pcd_path, raw_lidar_cloud_, rgb_image_);
...
void Calibration::loadImgAndPointcloudFromPCD(const std::string path, const std::string pcd_path,
                          pcl::PointCloud<pcl::PointXYZI>::Ptr &origin_cloud,
                          cv::Mat &rgb_img){
  origin_cloud =
      pcl::PointCloud<pcl::PointXYZI>::Ptr(new pcl::PointCloud<pcl::PointXYZI>);
  ...
  // read pointcloud
  if (pcl::io::loadPCDFile<pcl::PointXYZI>(pcd_path, *origin_cloud)== -1)
  {
